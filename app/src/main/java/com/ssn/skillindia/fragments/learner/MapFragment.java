...
public class MapFragment extends Fragment implements OnMapReadyCallback,
    ...
    private static final String TAG = LogHelper.makeLogTag(MapFragment.class);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Double lng = getActivity().getIntent().getDoubleExtra("lng", 0);
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        startActivity(new Intent(getActivity(), TrainingCenterDetailActivity.class));
    }
}
